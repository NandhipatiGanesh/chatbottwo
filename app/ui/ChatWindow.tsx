      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed lg:bottom-5 md:bottom-5 bottom-2 lg:right-5 md:right-5 right-0 lg:w-106 md:w-106 w-[100%] h-[95%] bg-[#F3F4EF] border-4 border-[#fff] rounded-2xl shadow-lg flex flex-col"
          >
            {/* Header */}
            ...
            <div className="p-1 border-t border-[#fff] bg-white flex items-center">
              <div className="w-full h-13 border border-[#7136ed] rounded-full flex items-center p-1 justify-between">
                <input
                  type="text"
                  value={input}
